import { Cross, Eye, EyeClosed, Loader2 } from 'lucide-react';
    ...
    return (
        <div className="w-full max-w-sm mx-auto bg-[#1D232A] text-white  rounded-md py-4 px-6 shadow-lg">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
                ...
                <p className="text-lg font-semibold">LogIn into Account</p>
            </div>
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex">
                        ...
                        <input
                            ...
                            placeholder="••••••••"
                        />
                        <p className='bg-blue-800 px-1 rounded-md cursor-pointer flex justify-center items-center'
            ...
            <div className="flex flex-col justify-center items-center mt-8">
                <p>OR</p>
                <p className='text-slate-400'>Don't have an Acoount ? <Link to={"/signup"} className='text-blue-500 underline'>SignUp</Link></p>
            </div>
        </div>
